          ...
          <div>
            ...
            <div className="flex space-x-4">
              {empresaInfo.redesSociales?.facebook && (
                <a href={empresaInfo.redesSociales.facebook} target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors" aria-label="Facebook">
              ...
              {empresaInfo.redesSociales?.tiktok && (
                <a href={empresaInfo.redesSociales.tiktok} target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors" aria-label="TikTok">
                  <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
